  ...
  return (
    ...
    <main>
        ...
        <div className="grid md:grid-cols-2 grid-cols-1  gap-10">
            ...
            <img src="/web.png" className='w-20 h-20 mx-auto'  alt="" />
            ...
            <div className="col-span-1 text-center p-5">
            <img src="/ui.png" className='w-20 h-20 mx-auto'  alt="" />
            ...
            <div className="col-span-1 text-center p-5">
            <img src="/webdev.png" className='w-20 h-20 mx-auto'  alt="" />
            ...
            <div className="col-span-1 text-center p-5">
            <img src="/responsive.png" className='w-20 h-20 mx-auto'  alt="" />
